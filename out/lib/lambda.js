System.register("../../lib/lambda", [], function() {
  "use strict";
  var __moduleName = "../../lib/lambda";
  function require(path) {
    return $traceurRuntime.require("../../lib/lambda", path);
  }
  ...
  defineFunction(Lambda.prototype, "substitute", function(o, n) {
    if (this.binder === o) {
      return this;
    } else if ((this.body.free().indexOf(n.name) !== -1) && (n.free().indexOf(this.binder) !== -1)) {
      var ns = gensym();
